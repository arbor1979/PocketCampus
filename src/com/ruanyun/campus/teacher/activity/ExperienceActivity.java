...
public class ExperienceActivity extends Activity {
	...
	int[] id = { R.drawable.experience_call, R.drawable.experience_course,
			R.drawable.experience_download, R.drawable.experience_exam,
			R.drawable.experience_questions };
	...
	private void initPageView() {
		...
		view4 = inflater.inflate(R.layout.experience_view_four, null);
		view5 = inflater.inflate(R.layout.experience_view_five, null);
